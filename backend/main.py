...
corralA = Corral(Home=home, number=num3)
...
corralB = Corral(Home=home, number=num4)
...
home.add_cart(cartA)
home.add_cart(cartB)
corralA.add_cart(cartA.id)
corralA.add_cart(cartB.id)
corralB.add_cart(cartA.id)
corralB.add_cart(cartB.id)
